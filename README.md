...
Calidus is the inner-system and base Space Age foundation. It includes the normal base and Space Age sciences, plus early inner-system sciences such as Muluna and Cerys style science packs. The Calidus Tech Card compresses that early foundation into a card used by later progression.
...
It also supports a number of optional quality-of-life and compatibility mods. See `info.json` for the exact dependency list.

## Credits

Razi Protocol exists because of the Factorio modding community. The original planets, enemies, mechanics, concepts, art, sounds, and icons belong to their respective authors and contributors.Huge thank you to the Foundry Discord server for all there help in creating this mod.
